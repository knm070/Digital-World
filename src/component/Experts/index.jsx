...
const Experts = () => {
  ...
  return (
    <div className='bg-[#F3F3F7] pt-[120px] pb-[52px] flex justify-center '>
        <div className='flex gap-[64px] xl:flex-col lg:flex-col md:flex-col md:px-[15px] sm:flex-col max-sm:flex-col max-sm:items-center '>
        <div className='flex flex-col items-start xl:items-center lg:items-center md:items-center sm:items-center max-sm:items-center'>
        ...
        <div className='grid grid-cols-2 grid-rows-2 gap-[24px] max-sm:grid-cols-1 max-sm:grid-rows-1 md:grid md:grid-cols-2 md:grid-rows-2 lg:grid-cols-2 lg:grid-rows-2 xl:grid-cols-2 xl:grid-rows-2 sm:flex sm:flex-col sm:items-center '>
