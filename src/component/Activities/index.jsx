  ...
  return (
    <div className='py-[80px] '>
        <div className='flex flex-col items-center justify-center px-[10px]'>
            ...
            >ACTIVITIES</p>
            <h2 className='pt-[16px] text-[48px] sm:text-[28px] md:text-[48px] max-sm:text-[20px]' style={{fontFamily:'Inter', fontWeight:'700', color:'#000000'}}>Upcoming activities</h2>
            <p className='text-[20px] text-center w-[719px] pt-[16px] sm:text-[16px] sm:w-full max-sm:text-[14px] max-sm:w-full md:w-[719px]' style={{fontFamily:'Inter', fontWeight:'400', color:'#000000CC'}}>Activities include professional support for startups, skill development seminars, and analysis for projects undertaken by the Ministry</p>
        </div>

        <div className='flex items-center justify-center gap-[20px] pt-[64px] px-[20px] flex-wrap w-full max-sm:pt-[40px] md:pt-[64px]'>
            {statistics.map((item, index) => {
                return(
                <div className='bg-[#FFFFFF] p-[24px]  max-w-[518px] w-full rounded-[48px] xl:max-w-[518px] lg:max-w-full lg:flex lg:flex-col lg:items-center lg:w-[518px]'>
                    ...
                    <div className='flex items-center justify-between pt-[24px]'>
                        <h3 className='text-[28px] max-sm:text-[18px]' style={{fontFamily:'Inter', fontWeight:'700', color:'#030712'}}>{item.title}</h3>
                        <img src={Arrow45} alt="" />
                    </div>
