...
`
  ...
  return (
    <div className='bg-[#F3F3F7] py-[80px] '>
        <div className='flex flex-col items-center justify-center'>
            <p className='py-[4px] px-[16px] text-[12px] rounded-[16px]' 
            style={{ color : '#413DDE' , border: '1px solid'}}
            >ACTIVITIES</p>
            <h2 className='pt-[16px] text-[48px] ' style={{fontFamily:'Inter', fontWeight:'700', color:'#000000'}}>Upcoming activities</h2>
            <p className='text-[20px] text-center w-[719px] pt-[16px]' style={{fontFamily:'Inter', fontWeight:'400', color:'#000000CC'}}>Activities include professional support for startups, skill development seminars, and analysis for projects undertaken by the Ministry</p>
        </div>

        <div className='flex items-center justify-center gap-[20px] pt-[64px]'>
            {statistics.map((item, index) => {
                return(
                <div className='bg-[#FFFFFF] p-[24px] max-w-[518px] w-full rounded-[48px]'>
                    <img src={item.image} alt=""  className='rounded-[32px]' />
                    ...
                    <p className='pt-[20px] text-[20px]'style={{fontFamily:'Inter', fontWeight:'400', color:'#000000CC'}}>{item.text}</p>
