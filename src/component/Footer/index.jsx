...
const Footer = () => {
  return (
    ...
    <div className=' container'>
        <div className='flex justify-between w-full pb-[48px]' style={{borderBottom: '1px solid #0000001A'}}>
            <div className='w-[330px]'>
                <div className='flex items-center gap-[24px] '>
                    <img src={logo} alt="" />
                    <h2 className='text-[24px]' style={{fontFamily:'Inter', fontWeight:'600', color:'#030712'}}>Raqamli dunyo</h2>
                </div>
                <p className='text-[13px] pt-[24px]' style={{fontFamily:'Inter', fontWeight:'400', color:'#4B5563'}}>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley.</p>
            </div>
